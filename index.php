        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="pendaftaran.php" method="post" role="form">
              ...
              <div class="form-group">
                <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukkan Nama" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <textarea class="form-control" name="alamat" rows="5" placeholder="masukan alamat" required></textarea>
              </div>
               <div class="form-group">
